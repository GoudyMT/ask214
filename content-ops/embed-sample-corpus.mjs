...
writeFileSync('static/corpus/corpus-v1.0.2.json', JSON.stringify(manifest));
writeFileSync('static/corpus/corpus-v1.0.2.embeddings.bin', Buffer.from(embeddingsBuffer));
console.log(
