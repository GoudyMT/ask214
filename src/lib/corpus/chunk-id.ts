...
/**
 * The chunk-id identity rule (A1-D6). id = `${sourceId}:${sha256(normalizeText(text)).slice(0,12)}`.
 ...
 * intra-source EXACT duplicate is disambiguated by the chunk-assignment step (A3) appending `-<n>`; this
