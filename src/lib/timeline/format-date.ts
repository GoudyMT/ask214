 ...
 * "Mon D, YYYY" form the timeline cards + the /timeline subline display (locked Session 19;
 * raw ISO stays the storage/anchoring form). Maps the calendar parts directly - no Date
 ...
 *
 * Source: Timeline Engine design spec (2026-06-03) section 7 (view), Session 19 date-format lock.
 */
